    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 overflow-x-hidden">
      ...
      <div className="mb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 min-[768px]:gap-6">
          ...
          <div className="bg-gradient-to-br from-red-900/20 to-orange-900/20 backdrop-blur-sm rounded-2xl shadow-2xl border border-red-500/30 p-6 relative overflow-hidden hover:border-red-400/50 transition-all duration-300">
            ...
            <div className="mb-4">
              ...
              <h3 className="text-white font-bold text-lg">América vs Chivas</h3>
            </div>
